...
Config.Zones = {
	...
	MecanoActions = {
		Pos   = { x = -213.09, y = -1331.85, z = 22.14 },
	...
	Craft = {
		Pos   = { x = 475.472, y = -1310.27, z = 28.20 },
	...
	VehicleSpawnPoint = {
		Pos   = { x = -166.33, y = -1302.83, z = 31.28 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = -1,
	},

	VehicleDeleter = {
		Pos   = { x = -162.67, y = -1302.41, z = 30.32 },
	...
	VehicleDelivery = {
		Pos   = { x = -177.62, y = -1295.21, z = 30.34 },
